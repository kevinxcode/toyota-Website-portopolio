...
var WeekHeadColor = "#a04030"; //var WeekHeadColor="#a04030";//Background Color in Week header.
var SundayColor = "#f6c94f"; //var SundayColor="#f6c94f";//Background color of Sunday.
var SaturdayColor = "#f6c94f"; //Background color of Saturday.
var WeekDayColor = "#f0f0f0"; //Background color of weekdays.
...
var imageFilesPath = "css/date/images/";
...
function RenderCssCal(bNewCal)
{
	...
	else //if not to show time.
	{
	    ...
	    //close button
	    if (UseImageFiles) {
	        vCalClosing += "<span class='glyphicon glyphicon-remove' onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();'onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></span></td>";
	    }
	    else {
	...
	if (!winCal)
	{
		...
		span.style.zIndex = 1000000000000000;
...
function pickIt(evt)
{
	...
	if (domStyle)
	{
		domStyle.zIndex = 10000000000000000000;
		return false;
	}
