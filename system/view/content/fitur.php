...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
   <?php
                        ...
                        ?>
						<form method="post" action="control/input_fitur.php" class="form-horizontal">
														  <!-- CKEditor -->
                                            ...
                                            <div class="form-line">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<textarea id="ckeditor" name="fitur" ></textarea>
																	</div>
																</div>
															</div>
															<!-- Jquery Core Js -->
...
//        query
$input=$_POST[tcari];
        $sql =  "SELECT * FROM fitur where id_mobil='$_GET[id_mobil]' ORDER BY jenis_fitur asc";
                    ...
                    ?>
												<tr>
													...
													<td>
															...
															<a href="control/hapus_fitur.php?id_fitur=<?php echo $data['id_fitur']; ?>"><button class="btn btn-xs btn-danger">
