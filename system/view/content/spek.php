...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
   <?php
                        ...
                        ?>
						<form method="post" action="control/input_spek.php" class="form-horizontal">
														  <!-- CKEditor -->
                                            ...
                                            <div class="form-line">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<textarea id="ckeditor" name="spek" ></textarea>
																	</div>
																</div>
															</div>
															<!-- Jquery Core Js -->
...
//        query
$input=$_POST[tcari];
        $sql =  "SELECT * FROM mobil_spek where id_mobil='$_GET[id_mobil]' ORDER BY id_spek asc";
