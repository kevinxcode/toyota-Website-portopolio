														...
														<form method="post" enctype="multipart/form-data" class="form-horizontal">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="mobil"  value="<?php echo $data['mobil']; ?>"  class="col-xs-12 col-sm-6" />
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="harga"  value="<?php echo $data['harga']; ?>"  class="col-xs-12 col-sm-6" />
...
//        query
$input=$_POST[tcari];
        $sql =  "SELECT * FROM mobil_foto where id_mobil='$_GET[id_mobil]' ORDER BY id_mobil desc";
