...
<?php
	...
	if(isset($_POST['btnsave']))
	{
		...
		else
		{
			...
			$file_foto = $id_mobil."Lain-".rand(100,10000).".".$imgExt;
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO mobil_foto_lain(id_mobil,mobil,file_foto) 
			VALUES(:uname, :mobil, :file_foto)');
														...
														<form method="post" enctype="multipart/form-data" class="form-horizontal">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="hidden" name="mobil"  value="<?php echo $data['mobil']; ?>"  class="col-xs-12 col-sm-6" />
																	
																		<input type="hidden" name="id_mobil"   value="<?php echo $data['id_mobil']; ?>"  class="col-xs-12 col-sm-6" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">Foto Mobil:</label>
...
//        query
$input=$_POST[tcari];
        $sql =  "SELECT * FROM mobil_foto_lain  where id_mobil='$_GET[id_mobil]' ORDER BY id_mobil desc";
        ...
        ?><div class="table-responsive">
                    ...
                    ?>
												<tr>
													...
													<a href="control/delete_foto_lain.php?id_foto_mobil_lain=<?php echo $data['id_foto_mobil_lain']; ?>"><button class="btn btn-xs btn-danger">
